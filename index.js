...
const setGridNumbers = () => {
    ...
    const mahaDashaNum = parseInt(document.getElementById('mahadasha').textContent);
    const antarDashaNum = parseInt(document.getElementById('antardasha').textContent);
